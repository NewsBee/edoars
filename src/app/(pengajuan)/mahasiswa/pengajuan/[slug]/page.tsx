  ...
  return (
    <>
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto w-full mt-3 px-4 sm:px-6 lg:px-8">
          <Breadcrumb  pageName={params.slug.replace(/-/g, ' ').replace(/\b\w/g, char => char.toUpperCase())} />
        </div>
        {/* <ExistingSubmission submission={existingSubmission} /> */}

        {existingSubmission ? (
          <ProposalSubmissionPage submission={existingSubmission} />
        ) : (
          // <ExistingSubmission submission={existingSubmission} />
          <InputSubmission typeSlug={params.slug} />
        )}
