...
const Sidebar = ({
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`absolute left-0 top-0 z-9999 flex h-full w-72.5 flex-col border-r rounded-xl border-stroke dark:border-stroke-dark lg:static lg:translate-x-0 ${
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 xl:py-10">
          <Link href="/">
            <div className="flex items-center">
              ...
              <span className="ml-2 font-bold text-2xl text-white">E-Doars</span>
            </div>
          </Link>
