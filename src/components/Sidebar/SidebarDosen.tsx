      ...
      menuItems: [
        {
          ...
          route: "/dosen/monitoring-pengajuan",
          icon: <IoMdPaper />, // Paper icon
          children: availableTypes.map((type) => ({
            label: type.name,  // Using 'name' from API
            route: `/dosen/monitoring-pengajuan/${type.slug}`,  // Dynamic route based on slug
          })),
        },
        {
          label: "Tipe Pengajuan Berkas",
          route: "/dosen/tipe-pengajuan-berkas",
          icon: <GiTripleLock />, // Lock icon
        },
        {
          label: "Kelompok Keahlian",
          route: "/dosen/kelompok-keahlian",
          icon: <GiTripleLock />, // Lock icon
        },
        {
          label: "Pengumuman",
