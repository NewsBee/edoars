...
interface SidebarProps {
  ...
  role?: string; // Tambahkan role sebagai props
...
const SidebarDosen = ({
      ...
      menuItems: [
        ...
        },
        {
          ...
          children: availableTypes.map((type) => ({
            ...
            route: `/dosen/pengajuan/${type.slug}`, // Dynamic route based on slug
          })),
          //   children: [

          //     {
          //       label: "Pengajuan Judul (Pra TA)",
          //       route: "/dosen/pengajuan/praskripsi",
          //     },
          //     {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`absolute left-0 top-0 z-9999 flex h-full w-72.5 flex-col rounded-xl border-r border-stroke dark:border-stroke-dark lg:static lg:translate-x-0 ${
          sidebarOpen
            ? "translate-x-0 duration-300 ease-linear"
            : "-translate-x-full"
        } bg-gradient-to-b from-primaryBlue to-secondaryBlue`}
      >
        {/* Header Sidebar */}
