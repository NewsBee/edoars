    ...
    menuItems: [
      {
        ...
        //   { label: "Pengajuan Judul", route: "/ss" },
        //   { label: "Calender", route: "/clone" },
        // ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Pengajuan Judul", route: "/pengajuan/praskripsi" },
          { label: "Pengajuan Seminar", route: "/ss" },
          { label: "Pengajuan Sidang", route: "/clone" },
        ],
      },
      {
        icon: (
...
const SidebarOld = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
          ...
          <Link href="/">
            <div className="flex items-center">
              <div className="w-8 h-8">
                <Image
                  src={"/images/logo/logo-arsitek-new.png"} // Path ke gambar logo Anda
                  alt="Logo"
                  priority
              ...
              <span className="ml-2 font-bold text-2xl text-black dark:text-white">E-Doars</span>
            </div>
            {/* <Image
              width={176}
              height={32}
