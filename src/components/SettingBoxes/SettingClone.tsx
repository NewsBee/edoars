...
const SettingForm = () => {
  ...
  // Handle the form submission (PUT request to update profile)
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("/admin/profil"); // Redirect to user list page or another page
      } else {
  ...
  return (
    <>
      ...
      <div className="mt-2 w-full rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        <div className="rounded-[10px] border border-stroke bg-white text-center shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
          <div className="border-b border-stroke px-7 py-4 dark:border-dark-3">
