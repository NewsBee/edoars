...
import ProjectInfo from './HeaderPengajuan';
import NavigasiPengajuan from './NavigasiPengajuan';
        ...
        <div className="p-6  dark:bg-gray-800 min-h-screen">
            <div className="max-w-7xl mx-auto">
                <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md mb-6">
                    {documents.map((doc) => (
                        <div key={doc.id} className="border-b py-6 flex justify-between items-center">
                            <div>
                                <div className="text-xl font-semibold text-gray-800 dark:text-gray-200">{`#${doc.id} - ${doc.title}`}</div>
                                <div className="text-sm text-gray-600 dark:text-gray-400">Terakhir update: {doc.lastUpdated}</div>
                            ...
                            <div className="flex space-x-2">
                                ...
                                <button className="px-4 py-2 bg-purple-500 text-white rounded-lg shadow-md hover:bg-purple-600 transition duration-300">
                                    Download
                                </button>
                            </div>
                        </div>
